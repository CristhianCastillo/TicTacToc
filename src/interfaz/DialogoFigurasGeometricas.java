...
public class DialogoFigurasGeometricas extends JDialog implements ActionListener, MouseListener {
     ...
     */
    private final JLabel lblNombreFigura;

    /**
     * Etiqueta ruta de la imagen de la figura geometrica.
     */
    private final JLabel lblRutaFigura;

    /**
     * Etiqueta figura geomtrica seleccionada.
     */
    private final JLabel lblFiguraSeleccionada;

    /**
     * Campo de texto Nombre figura geometrica.
     */
    private final JTextField txtNombreFigura;

    /**
     * Campo de texto Ruta de la imagen de la figura geometrica.
     */
    private final JTextField txtRutaFigura;

    /**
     * Campo de texto Figura geometrica seleccionada.
     */
    private final JTextField txtFiguraSeleccionada;

    /**
     * Boton Agregar figura geometrica.
     */
    private final JButton btnAgregarFigura;

    /**
     * Boton Seleccionar figura geometrica.
     */
    private final JButton btnSeleccionarFigura;

    /**
     * Boton Actualizar figura geomtrica.
     */
    private final JButton btnActualizarFigura;

    /**
     * Boton Eliminar figura geometrica.
     */
    private final JButton btnEliminarFigura;
     ...
     * Controlador figuras.
     */
    private final ControladorFiguras ctrl;
    ...
    /**
     * Metodo que escucha los eventos generados por el click.
     * @param e Evento generado por el Click. e != null.
     */
    @Override
